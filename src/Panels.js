    ...
    return (
        <div>
            ...
            <div className="mainSide">
                ...
                <p className="sub2"> <b>Star Wars: RANKED</b></p>
                <i className="info">TT @Wes_The_Dragon @Tentimesthewxnder @spaceboy_78</i>
                ...
                <i className="info"> IG @humbleproductionsatl</i>
                ...
                <i className="info">IG @peachslicecreatives</i>
                ...
                <p className="info">More information coming soon! Check out the panelist here: {"\n"} <a className="link" href="https://harriyanna.carrd.co/">https://harriyanna.carrd.co/</a></p>
                <p className="sub2"><b>Idolfest</b></p>
                <i className="info">TT @bubblestarlive @10yin.cos @sliverskylan</i>
